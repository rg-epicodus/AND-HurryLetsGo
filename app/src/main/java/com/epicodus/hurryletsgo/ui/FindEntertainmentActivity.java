...
public class FindEntertainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_entertainment);
    ...
    private void getPlaces(String location) {
        ...
        apiService.findEntertainment(location, new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                ...
                FindEntertainmentActivity.this.runOnUiThread(new Runnable() {

                    @Override
                    public void run() {
                        mAdapter = new PlaceListAdapter(getApplicationContext(), mPlaces, mOnPlaceSelectedListener);
                        mRecyclerView.setAdapter(mAdapter);
                        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(FindEntertainmentActivity.this);
